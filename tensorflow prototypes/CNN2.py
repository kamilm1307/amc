#=========================================================================
# Title:            Convolutional Neural Network 2 Tensorflow Prototype
...
model = tf.keras.Sequential([
    tf.keras.layers.Conv2D(256, activation='relu', kernel_size=(1,3), strides=(1,1), padding='same', input_shape=(2, 128, 1)),
    tf.keras.layers.Conv2D(80, activation='relu', kernel_size=(2,3), strides=(1,1), padding='same'),
