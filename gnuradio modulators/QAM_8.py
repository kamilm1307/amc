...
class QAM_8(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "8QAM")

        ##################################################
        # Variables
        ##################################################
        self.variable_constellation_0 = variable_constellation_0 = digital.constellation_calcdist([(-1+0.3333333333333333j), (-0.3333333333333333+0.3333333333333333j), (0.3333333333333333+0.3333333333333333j), (1+0.3333333333333333j), (-1-0.3333333333333333j), (-0.3333333333333333-0.3333333333333333j), (0.3333333333333333-0.3333333333333333j), (1-0.3333333333333333j)], [0, 1, 2, 3, 4, 5, 6, 7],
        4, 1).base()
        self.sps = sps = 8
        self.samp_rate = samp_rate = 2.4e6
        self.carrier_freq = carrier_freq = transmit_gain
...
def main(top_block_cls=QAM_8, options=None):
    tb = top_block_cls()
