...
print("Received Parameters:", transmit_gain, transmit_frequency, transmit_audio)

class AMDSB(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "AMDSB")
...
def main(top_block_cls=AMDSB, options=None):
    tb = top_block_cls()
