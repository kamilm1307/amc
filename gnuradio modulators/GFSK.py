...
class GFSK(gr.top_block):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0_0.set_center_freq(float(transmit_frequency), 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_random_uniform_source_x_0, 0), (self.digital_gfsk_mod_0, 0))
        self.connect((self.digital_gfsk_mod_0, 0), (self.osmosdr_sink_0_0, 0))
