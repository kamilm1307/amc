...
class AMLSB(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "AMLSB")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 41.1e3, 1000, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=AMLSB, options=None):
    tb = top_block_cls()
