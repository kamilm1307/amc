...
class PSK_8(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "8PSK")

        ##################################################
        # Variables
        ##################################################
        self.variable_constellation_0 = variable_constellation_0 = digital.constellation_8psk().base()
        self.sps = sps = 8
...
def main(top_block_cls=PSK_8, options=None):
    tb = top_block_cls()
